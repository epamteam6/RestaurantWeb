...
--
-- Хост: 10.0.2.10
-- Время создания: Окт 27 2017 г., 14:34
...
CREATE TABLE IF NOT EXISTS `Dishes` (
  ...
  `dish_type_id` smallint(6) NOT NULL,
...
--
ALTER TABLE `Dishes`
  ADD CONSTRAINT `Dishes_ibfk_1` FOREIGN KEY (`dish_type_id`) REFERENCES `Dish_Types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `Dishes_Orders`
--
ALTER TABLE `Dishes_Orders`
  ADD CONSTRAINT `Dishes_Orders_ibfk_1` FOREIGN KEY (`dish_id`) REFERENCES `Dishes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Dishes_Orders_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `Orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
