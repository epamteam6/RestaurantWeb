...
<head><title><fmt:message key="admin_bill.title" /></title></head>

<section>
    <div class="bg-title-sub-page bg-menu-page-01">
        <div class="wrap-title-sub-page">
            <h2 class="title-l"><fmt:message key="admin_bill.title" /></h2>
            <h6 class="title-s"><fmt:message key="admin_bill.slide" /></h6>
        </div>
    </div>
</section>
        ...
        <form method="post" action="admin_bill_creation">
            ...
            <div class="wrap-total clearfix" >
                ...
                <div class="style-pos col-right">
                    <input class="btn-with-bg" name="Bill" type="submit" value="<fmt:message key="admin_bill.bill" />">
                </div>
