...
<head><title>Bill Creation</title></head>

<section>
    <div class="bg-title-sub-page bg-menu-page-01">
        <div class="wrap-title-sub-page">
            <h2 class="title-l">Bill Creation</h2>
            <h6 class="title-s">Home / Bill Creation</h6>
        </div>
    </div>
</section>
        ...
        <form method="post" action="admin_bill_creation">
            ...
            <div class="wrap-total clearfix" >
                ...
                <div class="style-pos col-right">
                    <input class="btn-with-bg" name="Bill" type="submit" value="Make Bill">
                </div>
