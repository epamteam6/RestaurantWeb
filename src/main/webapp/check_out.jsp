            ...
            <div class="wrap-check-out-method">
                ...
                <div class="row">
                    <div class="col-res-check-out-method col-md-5">
                        <input class="input-check-out small-text" type="text" name="username" placeholder="Username or email" />
                    </div>
                    <div class="col-res-check-out-method col-md-5">
                        <input class="input-check-out small-text" type="password" name="password" placeholder="Password" />
                    </div>
                    <div class="wrap-btn-login col-md-2">
                        <button class="btn-login-extend btn-with-bg">LOG IN</button>
                        <a href="#" class="small-text">Lost your password?</a>
            ...
            <div class="wrap-payment">
                ...
                <p>
                    ...
                    <span class="wrap-icon-pay first">
							<img src="./images/icons/visa.png" class="img-no-color" alt="img-paypal " />
							<img src="./images/icons/visa-img.png" class="img-color" alt="img-paypal " />
						</span>
                    <span class="wrap-icon-pay">
							<img src="./images/icons/paypal.png" class="img-no-color" alt="img-paypal" />
							<img src="./images/icons/paypal-img.png" class="img-color" alt="img-paypal" />
						</span>
                    <span class="wrap-icon-pay">
							<img src="./images/icons/master-card.png" class="img-no-color" alt="img-paypal" />
							<img src="./images/icons/master-card-img.png" class="img-color" alt="img-paypal" />
						</span>
                    <span class="wrap-icon-pay">
							<img src="./images/icons/american-express.png" class="img-no-color" alt="img-paypal" />
							<img src="./images/icons/american-express-img.png" class="img-color" alt="img-paypal" />
						</span>
                    <span class="wrap-icon-pay">
							<img src="./images/icons/discover.png" class="img-no-color" alt="img-paypal" />
							<img src="./images/icons/discover-img.png" class="img-color" alt="img-paypal" />
						</span>
                </p>
                <p>
