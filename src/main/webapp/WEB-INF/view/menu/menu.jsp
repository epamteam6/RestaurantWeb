...
<page:template>
    ...
    <jsp:attribute name="title">Our Menu</jsp:attribute>
    <jsp:body>
        ...
        <div class="row">
            <div class="col-content col-sm-10 col-md-8 col-lg-5">
                <div class="img-reservation-03 hover-img">
                    <img src="${pageContext.request.contextPath}/resources/images/menu-03-img-01.jpg" alt="img-menu" />
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="s-screen col-content col-sm-10 col-md-8 col-lg-5">
                <div class="img-reservation-03 hover-img">
                    <img src="${pageContext.request.contextPath}/resources/images/home-onepage-img-menu.jpg" alt="img-menu" />
                </div>
            </div>
...
<section class="restyle-menu-03 home-onepage-menu content-reservation-03">
    <div class="container">
        <div class="row">
            <div class="col-content col-sm-10 col-md-8 col-lg-5">
                <div class="img-reservation-03 hover-img">
                    <img src="${pageContext.request.contextPath}/resources/images/menu-03-img-03.jpg" alt="img-menu" />
                </div>
            </div>
